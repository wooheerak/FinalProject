	...
	<section class="section"
		...
		<c:if test="${ empty sessionScope.loginUser }">
			<form class="lForm" action="userlogin.ul" method="post">
				...
				<div class="col-md-3"
					style="margin-left: 40px; border: 1px solid lightgray; padding: 20px; margin-top: 25px;">
					<label for="uname"><b>Student Id</b></label> <input class="lInput"
						...
						class="lInput" type="password" placeholder="Enter Password"
		...
		<c:if test="${ !empty sessionScope.loginUser }">
			<div class="col-md-3"
				style="margin-left: 40px; border: 1px solid lightgray; padding: 0px; margin-top: 25px; height: 294px;">
				<div>
					<img class="center" src="resources/images/logo.png"
						style="width: 120px; display: block; margin-left: auto; margin-right: auto; padding-top: 30px;" />
				</div>
				<div style="text-align: center; padding-top: 40px; font-size: 20px;">
					<b>${ loginUser.member_Name }</b><b>님,
						반갑습니다.</b>
				</div>
				<div style="display: block; text-align: center; margin-left: auto; margin-right: auto; padding-top: 30px;">
